...
| Extension | The test build, `glance-extension-app-1.0.2-chrome.zip`, from the landing page's **Try the test build** section, installed by hand (below). The Chrome Web Store listing (`ndedifeplcjgadmdjglnmlomdcndidgp`) isn't public yet. |
